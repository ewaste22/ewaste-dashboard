...
export default function User() {
  ...
  const getUser = async () => {
    await axios.get('http://localhost:8000/api/v1/admin/user', {
      headers:{
    ...
    <>
      ...
      <div className='container px-8 mx-auto my-10 pb-28'>
        <div className='bg-white border rounded-lg shadow-lg p-10'>
            ...
            <Link to={`/AddUser`}><button className="text-white absolute right-5  bg-[#85C681] font-medium rounded-lg text-sm px-4 py-2"> 
        Add</button></Link>
            </div>
            </div>
