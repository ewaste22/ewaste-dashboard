        ...
        <div className="relative bg-[#D9D9D9] md:ml-64">
          ...
          <div className='container px-8 mx-auto my-10 pb-28'>
            <div className='bg-white border rounded-lg shadow-lg p-10'>
                ...
                <h1 className='text-xl mb-2 font-bold'>News</h1>
                </div>
              ...
              <div className='inline-block min-w-full shadow overflow-hidden'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className='px-5 py-5 text-sm text-center'>
                      <p>6 Titik Pembuangan Sampah Elektronik di Kota Bandung Menurut DLH</p>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-5 py-5 text-sm text-center'>
                      <p>Berbahaya bagi Lingkungan, Ini Cara Mengurangi Sampah Elektronik</p>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className='px-5 py-5 text-sm text-center'>
                      <p>Hasilkan Zat Berbahaya, Bagaimana Penanganan Sampah Elektronik di Indonesia?</p>
                    </td>
